...
pub const Message = packed struct {
    ...
    pub const Payload = extern union {
        ...
        get_system_zero: void,
        set_system_zero: f32,
        get_system_axes: void,
        set_system_axes: u16,
        get_warmup_voltage: void,
        set_warmup_voltage: f32,
        get_default_magnet_length: void,
        set_default_magnet_length: packed struct {
            backward: f32,
            forward: f32,
        },
        get_vdc_target: void,
        ...
        get_motor_kbm: void,
        set_motor_kbm: f32,
        get_vehicle_length: void,
        set_vehicle_length: f32,
        get_hall_sensor_gap: void,
        set_hall_sensor_gap: f32,
